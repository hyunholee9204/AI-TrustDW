...
High 그룹은 더 비판적으로 본다는 것을 확인했습니다.
...
## 8. 향후 확장 가능성
- t-test, ANOVA 등의 통계적 검증
- 회귀 분석
- Tableau, Power BI 도구 기반 시각화, 다차원 분석 대시보드

---

## 9. 결론
본 프로젝트는 단순한 SQL 평균 비교 분석을 넘어, AI 신뢰 문제를 데이터 웨어하우스 기반으로 구조화, 정량화한 분석 사례입니다.<br>

분석 결과, AI 과신은 모델 정확도 자체보다는 사용자의 신뢰 형성 구조와 디지털 리터러시 수준에 더 크게 영향을 받는 것으로 나타났습니다.

특히, 디지털 리터러시가 낮을수록 Trust_Gap이 증가하는 경향을 확인했으며, 이는 AI 리스크가 기술적 성능 문제뿐만 아니라 사용자 인지 구조와도 밀접하게 연결되어 있음을 시사합니다.

AI 시스템의 안전성과 신뢰성을 논의할 때, 모델 성능뿐만 아니라 사용자 신뢰 보정또한 중요한 분석 대상이 되어야 함을 확인했습니다.
